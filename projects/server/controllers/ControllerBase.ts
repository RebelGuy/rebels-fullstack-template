...
import { ApiResponse, API_ERRORS, ErrorCode, ResponseData, ApiResponseData } from '@INIT__PATH_ALIAS/api-models/types'
import { Schema, SchemaType, validateObject } from '@INIT__PATH_ALIAS/server/controllers/schema'
import { NotFoundError } from '@INIT__PATH_ALIAS/shared/util/error'
...
export abstract class ControllerBase extends ContextClass {
  ...
  protected getCurrentUser (optional?: false): User
  protected getCurrentUser (optional: true): User | null
  protected getCurrentUser (optional?: boolean): User | null {
