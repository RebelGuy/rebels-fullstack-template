...
module.exports = (env) => {
  ...
  return {
    ...
    resolve: {
      extensions: ['.js', '.ts'],
      alias: {
        "@INIT__PATH_ALIAS/server": path.resolve(__dirname, '../../projects/server'),
        "@INIT__PATH_ALIAS/studio": path.resolve(__dirname, '../../projects/studio'),
        "@INIT__PATH_ALIAS/shared": path.resolve(__dirname, '../../projects/shared'),
        "@INIT__PATH_ALIAS/api-models": path.resolve(__dirname, '../../projects/api-models'),
      }
    },
