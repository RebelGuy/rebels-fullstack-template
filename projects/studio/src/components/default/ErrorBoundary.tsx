...
import CopyText from '@INIT__PATH_ALIAS/studio/components/default/CopyText'
import TextWithNewlines from '@INIT__PATH_ALIAS/studio/components/default/TextWithNewlines'
